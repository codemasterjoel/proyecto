                        ...
                        <div class="grid grid-cols-2 gap-4"> 
                            <div class="flex items-center justify-center py-4"> {{-- campo cedula --}}
                                <div class="w-full rounded-lg bg-gray-500">
                                    <div class="flex">
                                        <input wire:model="cedula" type="number"  class="w-full bg-white pl-2 text-base border font-semibold outline-0 rounded-tl-lg rounded-bl-lg border-slate-200" disable>
                                    </div>
                                </div>
                            </div>
